...
/// Provider for OpenAI chat completion API.
/// Supports GPT-3.5, GPT-4, and compatible endpoints.
struct OpenAIProvider: LLMProvider {
        ...
        let chatModels = modelsResponse.data
            ...
            .map { model -> LLMModel in
                LLMModel(
                    ...
                    supportsVision: model.id.contains("vision") || model.id.contains("gpt-4o") || model.id.contains("gpt-4-turbo"),
                    supportsTools: !model.id.contains("o1")  // o1 doesn't support tools yet
                )
            }

        return chatModels.isEmpty ? defaultModels : chatModels
    }
    ...
    func countTokens(_ text: String, model: String) -> Int {
        ...
        // A proper implementation would use tiktoken
        return text.count / 4
    }
    ...
    private func contextLength(for model: String) -> Int {
        ...
        case let m where m.contains("gpt-4o"):
            return 128_000
        case let m where m.contains("gpt-4-turbo"):
            return 128_000
        ...
        case let m where m.contains("gpt-3.5"):
            return 4_096
        case let m where m.contains("o1") || m.contains("o3"):
            return 128_000
        default:
            return 4_096
        }
    ...
    private var defaultModels: [LLMModel] {
        [
            LLMModel(id: "gpt-4o", name: "GPT-4o", contextLength: 128_000, supportsVision: true, supportsTools: true),
            LLMModel(id: "gpt-4o-mini", name: "GPT-4o Mini", contextLength: 128_000, supportsVision: true, supportsTools: true),
            LLMModel(id: "gpt-4-turbo", name: "GPT-4 Turbo", contextLength: 128_000, supportsVision: true, supportsTools: true),
            LLMModel(id: "gpt-4", name: "GPT-4", contextLength: 8_192, supportsVision: false, supportsTools: true),
            LLMModel(id: "gpt-3.5-turbo", name: "GPT-3.5 Turbo", contextLength: 16_385, supportsVision: false, supportsTools: true),
        ]
    }
}
